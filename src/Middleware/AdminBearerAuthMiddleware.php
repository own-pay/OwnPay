...
/**
 * Middleware responsible for authenticating Admin REST API requests using Bearer tokens (API keys) carrying the 'admin' scope.
 */
final class AdminBearerAuthMiddleware
{
    /**
    ...
    /**
     * Constructs a new instance of AdminBearerAuthMiddleware.
     *
