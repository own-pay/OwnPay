    ...
    public static function op_gateway_render($gateway_id = '', $data = [])
    {
        ...
        if ($response_gateway['status'] == true) {
            ...
            if (isset($instructions)) {
                ...
                echo '
                        <div id="op-image-modal" class="op-modal" style="display:none;">
                            <div class="op-modal-content">
                                <span class="op-close" onclick="op_close_image()">&times;</span>
                                <div class="op-model-image-b"><img id="op-modal-image" src="" alt="Preview"></div>
                            </div>
                        </div>

                        <script data-cfasync="false">
                            function op_show_image(src) {
                                const modal = document.getElementById("op-image-modal");
                                const img = document.getElementById("op-modal-image");
                            ...
                            function op_close_image() {
                                document.getElementById("op-image-modal").style.display = "none";
                            }
                        </script>
                    ';
            }
