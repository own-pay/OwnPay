                    ...
                    if ($response_brand['status'] == true) {
                        ...
                        if ($actionID == "approved") {
                            if (PermissionGuard::has($ctx, 'transaction', 'approve')) {
                                ...
                                if (class_exists('\OwnPay\Service\Auth\StatusGuard') && !\OwnPay\Service\Auth\StatusGuard::canTransition($currentStatus, 'completed')) {
                                    ...
                                    try {
                                        if (class_exists('\OwnPay\Service\Payment\LedgerService')) {
                                            $ledger = new \OwnPay\Service\Payment\LedgerService();
                        ...
                        if ($actionID == "refunded") {
                            if (PermissionGuard::has($ctx, 'transaction', 'refund')) {
                                $currentStatus = $response_brand['response'][0]['status'];
                                if (class_exists('\OwnPay\Service\Auth\StatusGuard') && !\OwnPay\Service\Auth\StatusGuard::canTransition($currentStatus, 'refunded')) {
                        ...
                        if ($actionID == "canceled") {
                            if (PermissionGuard::has($ctx, 'transaction', 'cancel')) {
                                $currentStatus = $response_brand['response'][0]['status'];
                                if (class_exists('\OwnPay\Service\Auth\StatusGuard') && !\OwnPay\Service\Auth\StatusGuard::canTransition($currentStatus, 'canceled')) {
