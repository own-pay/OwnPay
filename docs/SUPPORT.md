...
Need help with OwnPay? You're in the right place. This page points you to the best resource for your question so you get a good answer fast.

> 💡 **Please don't use the GitHub issue tracker for usage/support questions.** Issues are reserved for confirmed bugs and feature requests. Support questions there may be closed and redirected here.
...
If you've found a reproducible bug, please open a clear report:

➡️ **[Open an issue](https://github.com/own-pay/OwnPay/issues/new/choose)**

Include reproduction steps, what you expected, what happened, your environment, and any logs or screenshots.
...
For partnerships, sponsorships, press, or anything that doesn't fit the above:

- **General:** [ping@ownpay.org](mailto:ping@ownpay.org)
- **Sponsorship & donations:** [ownpay.org/donate](https://ownpay.org/donate)
