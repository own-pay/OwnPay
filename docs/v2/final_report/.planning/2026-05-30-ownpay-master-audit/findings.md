...
| FIND-019 | HIGH | 10 | Device pairing blocked by JwtAuthMiddleware (bootstrap deadlock) | config/routes/api.php:40 + middleware.php:72 + JwtAuthMiddleware:47-54 | CONFIRMED (Phase 3) — added to master report + mobile_architecture.md |
