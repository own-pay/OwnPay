...
return [
    ...
    'checkout.manual_verify.submitted'  => ['type' => 'action', 'location' => 'CheckoutController, PaymentIntentCheckoutController; listener: ManualPaymentVerificationService'],
    'checkout.manual_verify.verified'   => ['type' => 'action', 'location' => 'ManualPaymentVerificationService'],
