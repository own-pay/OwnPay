...
- Brands seeded: Own Pay (#1), Devoart (#2), Default Brand Store (Rahim Ahmed's home brand, richer data: revenue 5255, 6 customers, multi-currency txns). Brand switcher: click sidebar pill (≈115,80), the FIRST click after load often doesn't open the dropdown (JS timing) — click again; then Global View ≈(100,138).
