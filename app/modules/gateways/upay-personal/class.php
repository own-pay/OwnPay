...
class UpayPersonalGateway implements GatewayAdapterInterface
{
    use GatewayDefaults;
        ...
        public function lang_text(): array
    {
            return [
                '1' => [
                    'en' => 'Go to your Upay Mobile App.',
                    'bn' => 'আপনার উপায়  মোবাইল অ্যাপে যান।',
                ],
                ...
                '6' => [
                    'en' => 'Now enter your Upay PIN to confirm.',
                    'bn' => 'এখন নিশ্চিত করতে আপনার উপায়  পিন লিখুন।',
                ],
