...
class RocketMerchantGateway implements GatewayAdapterInterface
{
    use GatewayDefaults;
        public function info(): array
    {
            return [
                'title'       => 'Rocket Merchant',
        ...
        public function lang_text(): array
    {
            return [
                '1' => [
                    'en' => 'Go to your Rocket Mobile App.',
                    'bn' => 'আপনার রকেট  মোবাইল অ্যাপে যান।',
                ],
                ...
                '6' => [
                    'en' => 'Now enter your Rocket PIN to confirm.',
                    'bn' => 'এখন নিশ্চিত করতে আপনার রকেট  পিন লিখুন।',
                ],
