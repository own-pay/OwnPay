...
class TelecashPersonalGateway implements GatewayAdapterInterface
{
    use GatewayDefaults;
        public function info(): array
    {
            return [
                'title'       => 'Telecash Personal',
        ...
        public function lang_text(): array
    {
            return [
                '1' => [
                    'en' => 'Go to your Telecash Mobile App.',
                    'bn' => 'আপনার টেলিক্যাশ  মোবাইল অ্যাপে যান।',
                ],
                ...
                '6' => [
                    'en' => 'Now enter your Telecash PIN to confirm.',
                    'bn' => 'এখন নিশ্চিত করতে আপনার টেলিক্যাশ  পিন লিখুন।',
                ],
