...
namespace OwnPay\Modules\Gateways\Heartland;
...
/**
 * Heartland Payment Gateway Adapter.
 *
...
final class HeartlandGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'heartland',
            'version'     => '1.0.0',
            'description' => 'Heartland payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.heartland', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'api_key', 'label' => 'Heartland Secret API Key', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api2.heartlandportico.com/v2/charges'
            : 'https://cert.api2.heartlandportico.com/v2/charges';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api2.heartlandportico.com/v2/charges/' . $reference
            : 'https://cert.api2.heartlandportico.com/v2/charges/' . $reference;
