...
namespace OwnPay\Modules\Gateways\Shift4;
...
/**
 * Shift4 Payment Gateway Adapter.
 *
...
final class Shift4Gateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'shift4',
            'version'     => '1.0.0',
            'description' => 'Shift4 payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.shift4', [$this, 'handleWebhook']);
    }
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.shift4.com/charges/' . $reference
            : 'https://api.shift4.com/charges/' . $reference;
    ...
    {
        $webhookHeader = 'Shift4-Signature';
        $signature = '';
