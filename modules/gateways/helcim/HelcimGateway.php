...
namespace OwnPay\Modules\Gateways\Helcim;
...
/**
 * Helcim Payment Gateway Adapter.
 *
 * Implements strict PSR-4 type compliance, timing-safe webhook signing,
 * and sandboxed backchannel payment status checks.
 */
final class HelcimGateway implements PluginInterface, GatewayAdapterInterface, TestableConnectionInterface
{
    use GatewayDefaults;
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'helcim',
            'version'     => '1.0.0',
            'description' => 'Helcim payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.helcim', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'account_id', 'label' => 'Helcim Account ID', 'type' => 'text', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.helcim.com/api/v2/payment-intents'
            : 'https://sandbox.helcim.com/api/v2/payment-intents';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.helcim.com/api/v2/transactions/' . $reference
            : 'https://sandbox.helcim.com/api/v2/transactions/' . $reference;
    ...
    {
        $webhookHeader = 'X-Helcim-Signature';
        $signature = '';
