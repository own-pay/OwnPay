...
namespace OwnPay\Modules\Gateways\TrustCommerce;
...
/**
 * TrustCommerce Payment Gateway Adapter.
 *
 * Implements strict PSR-4 type compliance, timing-safe webhook signing,
 * and sandboxed backchannel payment status checks.
 */
final class TrustCommerceGateway implements PluginInterface, GatewayAdapterInterface
{
    use GatewayDefaults;
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'trustcommerce',
            'version'     => '1.0.0',
            'description' => 'TrustCommerce payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.trustcommerce', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'custid', 'label' => 'Customer ID', 'type' => 'text', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://tclink.trustcommerce.com/tcLink.php/charge'
            : 'https://tclinktest.trustcommerce.com/tcLink.php/charge';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://tclink.trustcommerce.com/tcLink.php/query' . $reference
            : 'https://tclinktest.trustcommerce.com/tcLink.php/query' . $reference;
