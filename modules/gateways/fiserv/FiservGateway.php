...
namespace OwnPay\Modules\Gateways\Fiserv;
...
/**
 * Fiserv Payment Gateway Adapter.
 *
...
final class FiservGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'fiserv',
            'version'     => '1.0.0',
            'description' => 'Fiserv payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.fiserv', [$this, 'handleWebhook']);
    }
    ...
    public function fields(): array
    {
        return [
            ...
            ['name' => 'shared_secret', 'label' => 'Shared Secret', 'type' => 'password', 'required' => true],
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://www.ipg-online.com/ipgapi/services/order/' . $reference
            : 'https://test.ipg-online.com/ipgapi/services/order/' . $reference;
