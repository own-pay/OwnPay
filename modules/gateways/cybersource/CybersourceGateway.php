...
namespace OwnPay\Modules\Gateways\Cybersource;
...
/**
 * Cybersource Payment Gateway Adapter.
 *
 * Implements strict PSR-4 type compliance, timing-safe webhook signing,
 * and sandboxed backchannel payment status checks.
 */
final class CybersourceGateway implements PluginInterface, GatewayAdapterInterface
{
    use GatewayDefaults;
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'cybersource',
            'version'     => '1.0.0',
            'description' => 'Cybersource payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.cybersource', [$this, 'handleWebhook']);
    }
    ...
    public function fields(): array
    {
        return [
            ...
            ['name' => 'api_key_id', 'label' => 'API Key ID', 'type' => 'text', 'required' => true],
            ['name' => 'shared_secret', 'label' => 'Shared Secret Key', 'type' => 'password', 'required' => true],
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.cybersource.com/pts/v2/payments/' . $reference
            : 'https://apitest.cybersource.com/pts/v2/payments/' . $reference;
