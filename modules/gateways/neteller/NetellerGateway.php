...
namespace OwnPay\Modules\Gateways\Neteller;
...
/**
 * Neteller Payment Gateway Adapter.
 *
...
final class NetellerGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'neteller',
            'version'     => '1.0.0',
            'description' => 'Neteller payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.neteller', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'client_id', 'label' => 'Neteller Client ID', 'type' => 'text', 'required' => true],
            ['name' => 'client_secret', 'label' => 'Neteller Client Secret', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.neteller.com/v1/orders'
            : 'https://api.sandbox.neteller.com/v1/orders';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.neteller.com/v1/orders/' . $reference
            : 'https://api.sandbox.neteller.com/v1/orders/' . $reference;
