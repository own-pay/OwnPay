...
namespace OwnPay\Modules\Gateways\Tsys;
...
final class TsysGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'tsys',
            'version'     => '1.0.0',
            'description' => 'TSYS payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.tsys', [$this, 'handleWebhook']);
    }
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.transfirst.com/api/v1/transactions'
            : 'https://stage.transfirst.com/api/v1/transactions';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.transfirst.com/api/v1/transactions/' . $reference
            : 'https://stage.transfirst.com/api/v1/transactions/' . $reference;
    ...
    {
        $webhookHeader = 'X-TSYS-Signature';
        $signature = '';
