...
namespace OwnPay\Modules\Gateways\BlueSnap;
...
/**
 * BlueSnap Payment Gateway Adapter.
 *
...
final class BlueSnapGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'bluesnap',
            'version'     => '1.0.0',
            'description' => 'BlueSnap payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.bluesnap', [$this, 'handleWebhook']);
    }
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://ws.bluesnap.com/services/2/payment-fields'
            : 'https://sandbox.bluesnap.com/services/2/payment-fields';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://ws.bluesnap.com/services/2/transactions/' . $reference
            : 'https://sandbox.bluesnap.com/services/2/transactions/' . $reference;
