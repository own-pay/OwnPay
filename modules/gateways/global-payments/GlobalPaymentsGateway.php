...
namespace OwnPay\Modules\Gateways\GlobalPayments;
...
/**
 * Global Payments Payment Gateway Adapter.
 *
...
final class GlobalPaymentsGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'version'     => '1.0.0',
            'description' => 'Global Payments payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.global-payments', [$this, 'handleWebhook']);
    }
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ...
            : 'https://api.sandbox.globalpay.com/v2/transactions';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.globalpay.com/v2/transactions/' . $reference
            : 'https://api.sandbox.globalpay.com/v2/transactions/' . $reference;
