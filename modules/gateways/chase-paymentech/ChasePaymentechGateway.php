...
namespace OwnPay\Modules\Gateways\ChasePaymentech;
...
/**
 * Chase Paymentech Payment Gateway Adapter.
 *
 * Implements strict PSR-4 type compliance, timing-safe webhook signing,
 * and sandboxed backchannel payment status checks.
 */
final class ChasePaymentechGateway implements PluginInterface, GatewayAdapterInterface
{
    use GatewayDefaults;
    ...
    public static function metadata(): array
    {
        return [
            ...
            'version'     => '1.0.0',
            'description' => 'Chase Paymentech payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.chase-paymentech', [$this, 'handleWebhook']);
    }
    ...
    public function fields(): array
    {
        return [
            ...
            ['name' => 'terminal_id', 'label' => 'Terminal ID', 'type' => 'text', 'required' => true],
            ['name' => 'bin', 'label' => 'BIN (e.g. 000001)', 'type' => 'text', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://ws.paymentech.net/PaymentechGateway/process'
            : 'https://wsvar.paymentech.net/PaymentechGateway/process';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://ws.paymentech.net/PaymentechGateway/verify' . $reference
            : 'https://wsvar.paymentech.net/PaymentechGateway/verify' . $reference;
    ...
    {
        $webhookHeader = 'X-Chase-Signature';
        $signature = '';
