...
namespace OwnPay\Modules\Gateways\Worldpay;
...
final class WorldpayGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'worldpay',
            'version'     => '1.0.0',
            'description' => 'Worldpay payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.worldpay', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'service_key', 'label' => 'Service Key', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ...
            : 'https://api.sandbox.worldpay.com/v1/orders';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.worldpay.com/v1/orders/' . $reference
            : 'https://api.sandbox.worldpay.com/v1/orders/' . $reference;
    ...
    {
        $webhookHeader = 'X-Worldpay-Signature';
        $signature = '';
