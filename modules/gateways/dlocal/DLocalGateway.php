...
namespace OwnPay\Modules\Gateways\DLocal;
...
final class DLocalGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'dlocal',
            'version'     => '1.0.0',
            'description' => 'dLocal payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.dlocal', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'x_login', 'label' => 'dLocal Login ID', 'type' => 'text', 'required' => true],
            ['name' => 'x_trans_key', 'label' => 'dLocal Transaction Key', 'type' => 'password', 'required' => true],
            ['name' => 'secret_key', 'label' => 'dLocal Webhook Secret Key', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.dlocal.com/api_v1/payments'
            : 'https://sandbox.dlocal.com/api_v1/payments';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.dlocal.com/api_v1/payments/' . $reference
            : 'https://sandbox.dlocal.com/api_v1/payments/' . $reference;
    ...
    {
        $webhookHeader = 'X-DLocal-Signature';
        $signature = '';
