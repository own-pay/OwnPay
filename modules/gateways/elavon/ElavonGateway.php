...
namespace OwnPay\Modules\Gateways\Elavon;
...
final class ElavonGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'elavon',
            'version'     => '1.0.0',
            'description' => 'Elavon payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.elavon', [$this, 'handleWebhook']);
    }
    ...
    public function fields(): array
    {
        return [
            ...
            ['name' => 'pin', 'label' => 'User PIN', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://www.convergepay.com/hostedpayments/transaction'
            : 'https://demo.convergepay.com/hostedpayments/transaction';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://www.convergepay.com/hostedpayments/verify' . $reference
            : 'https://demo.convergepay.com/hostedpayments/verify' . $reference;
