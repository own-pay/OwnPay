...
final class CellFinGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        if ($ch === false) {
            ...
            // not that CellFin actually confirmed the payment. Treating "can't reach the
            // checkback API" as success would let a compromised secret (or a down/DNS-poisoned
            // verify endpoint) complete a transaction with no real confirmation from CellFin.
            return [
                'success'        => false,
                'gateway_trx_id' => $gatewayTrxId,
                'amount'         => $amountDecimal,
