...
namespace OwnPay\Modules\Gateways\Stax;
 ...
 */
final class StaxGateway implements PluginInterface, GatewayAdapterInterface
{
    use GatewayDefaults;
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'stax',
            'version'     => '1.0.0',
            'description' => 'Stax payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.stax', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'api_key', 'label' => 'Stax Secret API Key', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://stax.fattmerchant.com/api/charge'
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://stax.fattmerchant.com/api/transactions/' . $reference
    ...
    {
        $webhookHeader = 'X-Stax-Signature';
        $signature = '';
