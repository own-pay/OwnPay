...
namespace OwnPay\Modules\Gateways\TwoCheckout;
...
final class TwoCheckoutGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => '2checkout',
            'version'     => '1.0.0',
            'description' => '2Checkout payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.2checkout', [$this, 'handleWebhook']);
    }
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.2checkout.com/rest/6.0/orders/' . $reference
            : 'https://api.2checkout.com/rest/6.0/orders/' . $reference;
