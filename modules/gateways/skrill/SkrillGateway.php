...
namespace OwnPay\Modules\Gateways\Skrill;
...
final class SkrillGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'skrill',
            'version'     => '1.0.0',
            'description' => 'Skrill payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.skrill', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'pay_to_email', 'label' => 'Skrill Account Email', 'type' => 'text', 'required' => true],
            ['name' => 'secret_word', 'label' => 'Skrill Secret Word', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://www.moneybookers.com/app/payment.pl/initiate'
            : 'https://www.moneybookers.com/app/payment.pl/initiate';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://www.moneybookers.com/app/payment.pl/verify' . $reference
            : 'https://www.moneybookers.com/app/payment.pl/verify' . $reference;
    ...
    {
        $webhookHeader = 'X-Skrill-Signature';
        $signature = '';
