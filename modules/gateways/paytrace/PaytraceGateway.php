...
namespace OwnPay\Modules\Gateways\Paytrace;
...
/**
 * Paytrace Payment Gateway Adapter.
 *
...
final class PaytraceGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    {
        $events->addAction('webhook.incoming.paytrace', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'username', 'label' => 'Paytrace Username', 'type' => 'text', 'required' => true],
            ['name' => 'password', 'label' => 'Paytrace Password', 'type' => 'password', 'required' => true],
    ...
    public function initiate(array $params, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.paytrace.com/v1/transactions/sale'
            : 'https://api.sandbox.paytrace.com/v1/transactions/sale';
    ...
    public function verify(array $callbackData, array $credentials): array
    {
        ...
        $endpoint = $mode === 'live'
            ? 'https://api.paytrace.com/v1/transactions/query' . $reference
            : 'https://api.sandbox.paytrace.com/v1/transactions/query' . $reference;
    ...
    {
        $webhookHeader = 'X-Paytrace-Signature';
        $signature = '';
