...
final class GooglePayGateway implements PluginInterface, GatewayAdapterInterface, TestableConnectionInterface
{
    ...
    /**
     * Initiates the Stripe Google Pay checkout session.
     */
    public function initiate(array $params, array $credentials): array
    {
        ...
        curl_setopt_array($ch, [
            ...
            CURLOPT_POSTFIELDS     => http_build_query([
                ...
                'line_items[0][price_data][product_data][name]' => 'Google Pay - Payment ' . $trxId,
    ...
    /**
     * Verifies the Google Pay checkout session status.
     */
