...
namespace OwnPay\Modules\Gateways\Fattmerchant;
...
/**
 * Fattmerchant Payment Gateway Adapter.
 *
...
final class FattmerchantGateway implements PluginInterface, GatewayAdapterInterface
{
    ...
    public static function metadata(): array
    {
        return [
            ...
            'slug'        => 'fattmerchant',
            'version'     => '1.0.0',
            'description' => 'Fattmerchant payment gateway integration for OwnPay',
            'author'      => 'OwnPay Core',
            'type'        => 'gateway',
        ];
    }
    ...
    {
        $events->addAction('webhook.incoming.fattmerchant', [$this, 'handleWebhook']);
    }
    ...
    {
        return [
            ['name' => 'api_key', 'label' => 'Fattmerchant Secret Key', 'type' => 'password', 'required' => true],
